...
from strategy import SuperTrendEMARegimeMTFPro
...
async def test_strategy():
    ...
    for tick in universe:
        ...
        try:
            ...
            if sig:
                print(f"✅ SEÑAL ENCONTRADA EN {iid}: {sig.side} a {sig.entry_price}")
        except Exception as e:
            print(f"❌ Error en {iid}: {e}")
            import traceback
            traceback.print_exc()
